...
import { obterPedido, salvarPedido } from './api.js';
...
export async function salvarEdicao(atualizarLista){
  ...
  try{
    await salvarPedido(window.__currentDocId, payload);
    closeModal();
